      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-white text-lg mb-12 max-w-2xl mx-auto leading-relaxed">
            Let&apos;s review what you&apos;ve chosen. If you&apos;re happy with
            your selections, simply click &quot;Finish Setup&quot; and you will
            be taken back to your personalized AJC Homepage. Remember, you can
            make changes at anytime by accessing your profile.
          </p>
